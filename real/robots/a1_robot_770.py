...
class A1Robot(a1.A1):
    ...
    def __init__(self,
        ...
        self._robot_interface = A1Interface()
        self._robot_interface.send_command(np.zeros(60, dtype=np.float32))  # TODO: do we need this line?
    ...
    """
        ...
        q = self._raw_state[0:4]
        self._base_orientation = np.array([q[1], q[2], q[3], q[0]])
        self._motor_pos = np.array(self._raw_state[7:19])
